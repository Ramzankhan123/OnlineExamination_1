<%-- 
    ...
    Created on : 2 Jun, 2018, 10:14:23 AM
    Author     : ramzan khan
--%>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('css_file/images/bg-01.jpg');">
			<div class="wrap-login100">
                            <form class="login100-form validate-form" method="post" action="student_login.jsp">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="umail" placeholder="xyz@gmail.com">
